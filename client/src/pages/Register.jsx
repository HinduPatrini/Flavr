      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-xs font-semibold text-stone-500 dark:text-stone-400 mt-1">
            Sign up to plan meals and save recipes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-stone-400 dark:text-stone-500 leading-tight pt-0.5">
              Choose any password — at least 6 characters long.
            </p>
          </div>
        ...
        <div className="text-center text-sm font-semibold">
          ...
          <Link to="/login" className="text-orange-500 hover:underline font-extrabold">
            Log in
          </Link>
        </div>
      </motion.div>
